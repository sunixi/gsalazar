...
public class StringHelper {
	...
	public static final String INVALID_WEB_CHARACTERS = "!\\\"^·$%&/¨Ç`´ç";
	...
	public static final String STRING_WEB_CHARACTERS = "abcdefghijklmnñopqrstuvwxyzABCDEFGHIJKLMNÑOPQRSTUVWXYZ";
	...
	public static String replaceFirst(String string, Character find, Character toReplace){
		String newValue = null;
		if(!isEmpty(find.toString()) && !isEmpty(toReplace.toString()))
			newValue = replaceFirst(string, find.toString(), toReplace.toString());
		else
			newValue = string;
