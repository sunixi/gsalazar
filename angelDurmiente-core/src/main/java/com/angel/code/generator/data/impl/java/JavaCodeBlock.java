...
public class JavaCodeBlock implements CodeBlock {
	...
	public String convertCode() {
		...
		for(CodeLine jlc: this.getCodeLines()){
			codeConverted += "\t" + jlc.convertCode();
		}
		return codeConverted;
	}

	public void addCodeLine(CodeLine javaLineCode){
		//this.getImportsType().addAll(javaLineCode.getImportsType());
		this.getCodeLines().add(javaLineCode);
	}
	 ...
	 */
	public void addLineCodeIf(String condition, JavaCodeBlock ifJavaBlockCode) {
	 ...
	 */
	public void addLineCodeIfElse(String condition, JavaCodeBlock ifJavaBlockCode, JavaCodeBlock elseJavaBlockCode) {
		String content = "if(" + condition + ") {\n";
