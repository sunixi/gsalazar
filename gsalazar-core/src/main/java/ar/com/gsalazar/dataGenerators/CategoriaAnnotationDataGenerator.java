...
import ar.com.gsalazar.rowProcessors.CategoriaPrincipalAnnotationRowProcessorCommand;
...
public class CategoriaAnnotationDataGenerator {
    ...
    public ImportFileProcessorRunner prepareImportFileProcessorRunner(FileProcessorDescriptor fileProcessorDescriptor) {
		ImportFileAnnotationProcessorRunner a = new ImportFileAnnotationProcessorRunner(fileProcessorDescriptor, new ExcelFileProcessorCommand(), new CategoriaPrincipalAnnotationRowProcessorCommand());
        return a;
    }
    ...
    public InputStream prepareInputStream() {
        try {
            return FileHelper.findInputStreamInClasspath(ResourceLocation.CATEGORIAS_PRINCIPALES_EXCEL_FILE);
        } catch (FileNotFoundException e) {
            throw new DataGeneratorException("File not found [" + ResourceLocation.CATEGORIAS_PRINCIPALES_EXCEL_FILE + "].", e);
        }
    }
